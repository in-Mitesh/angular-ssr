...
export class SearchService {
  ...
  public searchMovies(query: string,page?:number): Observable<IMovieTv> {
    return this.http.get<IMovieTv>(
      `search/movie?api_key=${this.apiKey}&query=${query}&page=${page}&sort_by=vote_average.desc&include_adult=false`
    );
  }
